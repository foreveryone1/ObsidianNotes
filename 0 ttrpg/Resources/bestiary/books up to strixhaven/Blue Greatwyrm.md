...
>
>### Legendary Actions
>The blue greatwyrm can take 3 legendary actions, choosing from the options below. Only one legendary action can be used at a time and only at the end of another creature's turn. The blue greatwyrm regains spent legendary actions at the start of its turn.
>
